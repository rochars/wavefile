...
describe("RF64 to RIFF", function() {
    ...
    wav2.toRIFF();
    fs.writeFileSync(path + "/out/RIFF-16bit-8kHz-stereo-from-RF64.wav", wav2.toBuffer());
    let wav = new WaveFile(fs.readFileSync(path + "/out/RIFF-16bit-8kHz-stereo-from-RF64.wav"));
