...
describe('8-bit a-law to 24-bit (a-law encoded with WaveFile)', function() {
    ...
    fs.writeFileSync(path + "/out/24bit-8kHz-noBext-mono-decoded-alaw.wav", wav2.toBuffer());

    var stats = fs.statSync(path + "/out/24bit-8kHz-noBext-mono-decoded-alaw.wav");
...
describe('16-bit to 8-bit a-law', function() {
    ...
    var stats = fs.statSync(path + "/out/8bit-alaw-8kHz-noBext-mono-encoded.wav");
    var fileSizeInBytes2 = stats["size"];
...
describe('16-bit stereo to 8-bit A-Law', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/8bit-alaw-8kHz-stereo-encoded.wav", wav2.toBuffer());

    var stats = fs.statSync(path + "/out/8bit-alaw-8kHz-stereo-encoded.wav");
    var fileSizeInBytes2 = stats["size"];
...
describe('8-bit a-law to 16-bit (a-law encoded with WaveFile)', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/16bit-8kHz-noBext-mono-decoded-alaw.wav", wav2.toBuffer());

    var stats = fs.statSync(path + "/out/16bit-8kHz-noBext-mono-decoded-alaw.wav");
    var fileSizeInBytes2 = stats["size"];
...
describe('8-bit mu-Law to 8-bit A-Law', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-mulaw.wav", wav2.toBuffer());

    var stats = fs.statSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-mulaw.wav");
    var fileSizeInBytes2 = stats["size"];
...
describe('4-bit ADPCM to 8-bit A-Law', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-ADPCM.wav", wav2.toBuffer());

    var stats = fs.statSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-ADPCM.wav");
    var fileSizeInBytes2 = stats["size"];
