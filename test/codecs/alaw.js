...
describe('8-bit a-law to 24-bit (a-law encoded with WaveFile)', function() {
    ...
    fs.writeFileSync(path + "/out/24bit-8kHz-noBext-mono-decoded-alaw.wav",
        wav2.toBuffer());
...
describe('8-bit mu-Law to 8-bit A-Law', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-mulaw.wav",
        wav2.toBuffer());
...
describe('4-bit ADPCM to 8-bit A-Law', function() {
    ...
    let wav2 = new WaveFile(wav.toBuffer());
    fs.writeFileSync(path + "/out/8bit-8kHz-mono-alaw-encoded-from-ADPCM.wav",
        wav2.toBuffer());
